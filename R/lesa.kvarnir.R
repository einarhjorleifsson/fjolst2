lesa.kvarnir <-
function(synis.id,teg,col.names=c("synis.id","aldur","lengd"),aldur=NULL,kyn=NULL,kynthroski=NULL,oslaegt=F,slaegt=F,lifur=F,kynfaeri=F,lengd=NULL,leidrett=F,oracle=fjolstOracle) {
